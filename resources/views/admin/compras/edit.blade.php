                                                        ...
                                                        @foreach ($compra->detalles as $detalle)
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center">
                                                                    <button type="button" class="btn btn-danger btn-sm delete-btn" data-id="{{ $detalle->id }}"><i class="bi bi-trash3-fill"></i></button>
                                                                </td>
                                                            </tr>
                                                            @php
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" id="id_proveedor" class="form-control" value="{{ $compra->proveedor->id }}"  name="proveedor_id" hidden >
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="fecha_compra" value="{{ $compra->fecha_compra }}" class="form-control">
                                                        @error('fecha')
                                                        <small style="color:red;"> {{ $message }} </small>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="comprobante" value="{{ $compra->comprobante }}" class="form-control">
                                                        @error('comprobante')
                                                        <small style="color:red;"> {{ $message }} </small>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <button type="submit" class="btn btn-success btn-block"><i class="bi bi-arrow-clockwise"></i> Actualizar compra</button>
                                                    </div>
                                                </div>
                                            </div>
