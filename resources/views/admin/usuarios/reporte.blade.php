    ...
    <div class="content">
        ...
        <table border="0" class=" table table-bordered" cellpadding="5">
            <tr>
                ...
                <td width="150px" style="background-color: #cccccc; text-align:center"><b>Nombre</b></td>
                <td width="190px" style="background-color: #cccccc; text-align:center"><b>Correo electrónico</b></td>
