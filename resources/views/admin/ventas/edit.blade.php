                                            ...
                                            <div class="row">
                                                <table class="table table-striped table-sm table-bordered table-group-divider table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($venta->detallesVenta as $detalle_venta )
                                                            <tr>
                                                                <td style="text-align: center">{{ $contador++ }}</td>
                                                                <td style="text-align: center">{{ $detalle_venta->producto->codigo }}</td>
                                                                <td style="text-align: center">{{ $detalle_venta->cantidad }}</td>
                                                                <td style="text-align: center">{{ $detalle_venta->producto->nombre }}</td>
                                                                <td style="text-align: center">{{ $detalle_venta->producto->precio_venta }}</td>
                                                                <td style="text-align: center">{{ $total = $detalle_venta->producto->precio_venta * $detalle_venta->cantidad }}</td>
                                                                <td style="text-align: center">
                                                                    <button type="button" class="btn btn-danger btn-sm delete-btn" data-id="{{ $detalle_venta->id }}"><i class="bi bi-trash3-fill"></i></button>
                                                                </td>
                                                            </tr>
                                                            @php
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" id="nombre_cliente_select" class="form-control" value="{{ $venta->cliente->nombre_cliente ?? 'S/N' }}" disabled>
                                                    <input type="text" id="id_cliente" class="form-control" name="cliente_id" value="{{ $venta->cliente->id ?? '' }}" hidden>
                                                </div>

                                                <div class="col-md-6">
                                                    <label for="">Código del cliente</label>
                                                    <input type="text" id="codigo_cliente_select" class="form-control" value="{{ $venta->cliente->codigo ?? '0' }}" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="fecha_venta" value="{{ old('fecha', $venta->fecha_venta) }}" class="form-control">
                                                        @error('fecha')
                                                        <small style="color:red;"> {{ $message }} </small>
                                                        @enderror
                                                    </div>
