    ...
    <div class="content">
        ...
        <table border="0" class=" table table-bordered" cellpadding="5">
            <tr>
                ...
                <td width="30px" style="background-color: #cccccc; text-align:center"><b>Código</b></td>
                ...
                <td width="95px" style="background-color: #cccccc; text-align:center"><b>Precio de compra</b></td>
                <td width="95" style="background-color: #cccccc; text-align:center"><b>Precio de vente</b></td>
                <td width="190px" style="background-color: #cccccc; text-align:center"><b>Fecha de ingreso</b></td>
            ...
            <tbody>
                ...
                @foreach ($productos as $producto )
                    <tr>
                        <td style="text-align: center">{{ $contador_producto++ }}</td>
